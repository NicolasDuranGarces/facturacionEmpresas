...
public class ProveedorIntegrationTest {
	...
	public void should_find_all_Proveedors() {
		Proveedor proveedor1 = new Proveedor("Carrera a verificar#1", "Proveedor A", "7755701");
		entityManager.persist(proveedor1);

		Proveedor proveedor2 = new Proveedor("Carrera a verificar#2", "Proveedor B", "7755702");
		entityManager.persist(proveedor2);

		Proveedor proveedor3 = new Proveedor("Carrera a verificar#3", "Proveedor C", "7755703");
	...
	public void should_update_Proveedor_by_id() {
		...
		Proveedor updatedProveedor = new Proveedor("Carrera update Tut B", "Proveedor Upd", "5555555");
	...
	public void should_delete_Proveedor_by_id() {
		Proveedor proveedor1 = new Proveedor("Carrera a verificar A", "Proveedor A", "7755700");
		entityManager.persist(proveedor1);

		Proveedor proveedor2 = new Proveedor("Carrera a verificar B", "Proveedor B", "7755701");
		entityManager.persist(proveedor2);

		Proveedor proveedor3 = new Proveedor("Carrera a verificar C", "Proveedor C", "7755702");
		entityManager.persist(proveedor3);
